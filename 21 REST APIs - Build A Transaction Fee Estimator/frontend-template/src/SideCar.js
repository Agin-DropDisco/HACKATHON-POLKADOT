  ...
  return (
    <Grid.Column width={8}>
      ...
      <Form>
        ...
        <Button onClick={getEstimate} style={{ background: '#383d51' , color: '#fff'}}>Estimate Fee</Button>
        {
          (estimate ?
            <Label color='blue' tag>
              Estimate Cost ~ {Number(estimate / 10000000).toFixed(4)} mDOT 
            </Label> :
              <div></div>
            )
        }
        <Form.Field>
          <Button primary onClick={submitTx} style={{ margin: '20px 0' ,  background: '#383d51'}}>
            Submit Transaction
          </Button>
        </Form.Field>
...
export default function Exestimate(props) {
